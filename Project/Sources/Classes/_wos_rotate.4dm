...
Function _resize()
	...
	$vP_ruler:=OBJECT Get pointer:C1124(Object named:K67:5; "rotate_Rlr")
...
Function _redraw()
	...
	End if 
	This:C1470._rotate_svg($vL_value)
	// *
	// *****
...
Function _rotation_menu()
	var $isOk : Boolean
	var $vC_al_rotations : Collection
	var $vL_value; $vL_rotation : Integer
	var $vT_MenuRef; $vT_rotation; $vT_answerMenu : Text
	$vC_al_rotations:=New collection:C1472()
	$vC_al_rotations.push(0; 45; 90; 135; 180; 225; 270; 315)
	$vT_MenuRef:=Create menu:C408
	For each ($vL_rotation; $vC_al_rotations)
		$vT_rotation:=String:C10($vL_rotation)
		APPEND MENU ITEM:C411($vT_MenuRef; $vT_rotation+"°")
		SET MENU ITEM PARAMETER:C1004($vT_MenuRef; -1; $vT_rotation)
	End for each 
...
Function _rotate_svg($vL_value : Integer)
	var $is_small : Boolean
	var $vL_width; $vL_height; $vL_svg_scale; $vL_colors; $vL_type; $vL_cx; $vL_cy; $vL_d; $vL_rxy; $vL_r; $vL_r1; $vL_size : Integer
	var $vJ_prefs : Object
	...
	$vT_svg_ref:=SVG_New($vL_width; $vL_height; "SVG_rot"; "SVG_rot"; True:C214; Truncated centered:K6:1)
	...
	Case of 
		...
		: ($vL_type=1)
			$vL_rxy:=3
			$vL_d:=wox_min($vL_width; $vL_height)  //*0.7
			$vL_r:=$vL_d/2
			$vT_svg_rect:=SVG_New_rect($vT_svg_group; $vL_cx-$vL_r; $vL_cy-$vL_r; $vL_d; $vL_d; $vL_rxy; $vL_rxy; k_none; $vT_fill)
	End case 
