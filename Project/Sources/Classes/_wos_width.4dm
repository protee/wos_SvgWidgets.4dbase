...
Function _update_all()
	...
	// *
Function _resize()
	var $vL_width; $vL_height; $vL_cx; $vL_cy; $vL_size; $vL_offset : Integer
	...
	$vL_cy:=$vL_height/2
	$vL_size:=11
	$vL_offset:=$vL_size*wos__storage_prefs().r_fontOffset_coef
	OBJECT SET COORDINATES:C1248($vP_canvas->; 0; 0; $vL_height; $vL_height)
	OBJECT SET COORDINATES:C1248(*; "ot_label"; $vL_height+4; $vL_cy-$vL_offset; $vL_width; $vL_height)
	// *
	// *****
...
Function _redraw()
	...
	$c4Fi_path:=Folder:C1567(fk resources folder:K87:11).file("images/width/width"+String:C10($vL_value)+".svg")
	READ PICTURE FILE:C678($c4Fi_path.platformPath; $vP_canvas->)
	OBJECT SET TITLE:C194(*; "ot_label"; String:C10($vL_value))
	// *
	// *****
...
Function _canvas_clicked()
	...
	var $vP_canvas : Pointer
	var $vT_path_menu; $vT_MenuRef; $vT_answerMenu : Text
	$is_editing:=Form:C1466.is_editing
	$vP_canvas:=OBJECT Get pointer:C1124(Object named:K67:5; "canvas")
	If ($is_editing)
		//$vJ_menu:=wos__storage_stuff().j_menu_stroke_linecap
		...
		For ($idx; 0; 9)
			APPEND MENU ITEM:C411($vT_MenuRef; wox_str_pluralise($idx; "point"))
