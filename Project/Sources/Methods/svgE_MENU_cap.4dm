...
#DECLARE($vT_refMenu : Text; $vL_cap : Integer)->$vT_refMenu_answer : Text
...
For ($i; 1; $tt)
	...
	SET MENU ITEM PARAMETER:C1004($vT_refMenu_answer; -1; "cap-"+String:C10($vL_idx))
...
APPEND MENU ITEM:C411($vT_refMenu; "Cap"; $vT_refMenu_answer)
