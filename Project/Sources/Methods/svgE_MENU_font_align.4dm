...
// Project Method: svgE_MENU_FONT_ALIGN
//
...
#DECLARE($vT_refMenu : Text; $vL_align : Integer)->$vT_refMenu_answer : Text
var $vC_lbl : Collection
var $tt; $i; $vL_idx : Integer
var $vJ_menu : Object
var $vT_path_menu : Text

$vJ_menu:=wos__storage_stuff.j_menu_text_align
...
For ($i; 1; $tt)
	...
	SET MENU ITEM PARAMETER:C1004($vT_refMenu_answer; -1; "font-align-"+String:C10($vL_idx))
	//SET MENU ITEM ICON($vT_refMenu_align;-1;$path_menu+String($vL_idx)+".svg")
	If ($vL_align=$vL_idx)
