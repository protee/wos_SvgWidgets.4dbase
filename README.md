...
Starting with 4D 21, the recommended way to install wos_SvgWidgets (and any ogTools component) is through the **Dependencies Manager** using the **GitHub repository**:
